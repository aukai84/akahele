...
let year2013 = require('../lib/data/json/YEAR_2013.json');

module.exports = {
  up: function (queryInterface, Sequelize) {

   return queryInterface.bulkInsert('Crimes', year2013.map(crime => {
        return {
            year: crime.year,
  ...
  down: function (queryInterface, Sequelize) {
    ...
    return queryInterface.bulkDelete('Crimes', year2013.map(crime => {
        return {
            year: crime.year,
            population: crime.population,
            violent_crime: crime.violent_crime,
