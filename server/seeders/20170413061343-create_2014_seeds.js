...
let year2014 = require('../lib/data/json/YEAR_2014.json');
module.exports = {
  up: function (queryInterface, Sequelize) {

    return queryInterface.bulkInsert('Crimes', year2014.map(crime => {
        return {
            year: crime.year,
  ...
  down: function (queryInterface, Sequelize) {
    ...
    return queryInterface.bulkDelete('Crimes', year2014.map(crime => {
        console.log(crime)
        return {
            year: crime.year,
            population: crime.population,
