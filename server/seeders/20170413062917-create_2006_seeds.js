...
let year2006 = require('../lib/data/json/YEAR_2006.json');

module.exports = {
  up: function (queryInterface, Sequelize) {

    return queryInterface.bulkInsert('Crimes', year2006.map(crime => {
        return {
            year: crime.year,
  ...
  down: function (queryInterface, Sequelize) {
    ...
    return queryInterface.bulkDelete('Crimes', year2006.map(crime => {
        return {
            year: crime.year,
            population: crime.population,
            violent_crime: crime.violent_crime,
