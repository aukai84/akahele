...
let year2005 = require('../lib/data/json/YEAR_2005.json');

module.exports = {
  up: function (queryInterface, Sequelize) {

    return queryInterface.bulkInsert('Crimes', year2005.map(crime => {
        return {
            year: crime.year,
  ...
  down: function (queryInterface, Sequelize) {
    ...
    return queryInterface.bulkDelete('Crimes', year2005.map(crime => {
        return {
            year: crime.year,
            population: crime.population,
            violent_crime: crime.violent_crime,
